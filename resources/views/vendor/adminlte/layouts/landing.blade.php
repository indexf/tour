...
<body data-spy="scroll" data-offset="0" data-target="#navigation">
    ...
    <div id="c">
        <div class="container">
            <p>
                <a href="//github.com/acacha/adminlte-laravel"></a><b>admin-lte-laravel</b></a>. {{ trans('adminlte_lang::message.descriptionpackage') }}.<br/>
                ...
                <br/>
                AdminLTE {{ trans('adminlte_lang::message.createdby') }} Abdullah Almsaeed <a href="//almsaeedstudio.com/">almsaeedstudio.com</a>
                <br/>
